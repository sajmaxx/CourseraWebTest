...
(function (global) 
{
  ...
  {
    // TODO: STEP 0: Look over the code from start to finish  -- DONE
 
      
      showLoading("#main-content");
        
      //   $ajaxUtils.sendGetRequest(homeHtmlUrl, function(responseText){                     //    <====== FOR TESTING ONLY! 
